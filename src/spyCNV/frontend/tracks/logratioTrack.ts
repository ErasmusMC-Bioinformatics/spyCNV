...
export const logratioTrack = (
  hrdData: CNVRecord[] | null,
  tso500Data: CNVRecord[] | null,
  ...
  const logratio_data_encoding = function (data_name: string, extraTooltip: unknown[] = []) {
    return {
      data: { name: data_name },
...
export const logratioBinTrack = (
  ...
  const logratio_bin_data_encoding = function (data_name: string, extraTooltip: unknown[] = []) {
    return {
      data: { name: data_name },
      transform: clampOutliers,
      mark: {
